...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        data = spacex_df[spacex_df['Launch Site'] == entered_site].groupby('class')['Flight Number'].count().reset_index()
        fig = px.pie(data, values='Flight Number', names='class', title=f'Total Success Launchess for site {entered_site}')
    return fig
# TASK 4:
